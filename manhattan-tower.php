  ...
  <div class="main-slider">
    ...
    <section class="feature-section section section-border-bottom section-padding">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <div class="feature-img"><img src="img/30-hudson-yard.jpg" class="img-responsive"></div>
          ...
          <div class="col-md-4">
            <div class="feature-img"><img src="img/manhattan-shop.jpg" class="img-responsive"></div>
          ...
          <div class="col-md-4">
            <div class="feature-img"><img src="img/placeholder.jpg" class="img-responsive"></div>
          ...
          <div class="col-md-4 col-md-offset-2">
            <div class="feature-img"><img src="img/sculpture.jpg" class="img-responsive"></div>
      ...
      <div class="row width-padding">
        <div class="col-md-6 col-md-offset-3">
          ...
          <div class="project-map-label">
              ...
              <div class="label-item">
                <h3 style="background:#5E5E5E;">~$2.9 <strong>Billion</strong></h3>
              </div>
              <strong class="plus-sign">+</strong>
              <div class="label-item">
              ...
              <div class="total-label">
                <h3>~$2.2 <strong>Billion <small>in total</small></strong></h3>
              </div>
          </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="img-responsive"><img src="img/job-creation.jpg"></div>
        </div>
        <div class="col-md-6">
