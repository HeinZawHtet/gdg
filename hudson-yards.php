    ...
    <div class="container">
      <div class="row">
        ...
        <h2 class="section-title text-center">Location</h2>
          <p class="margin-bottom">​​​​​​​​​Located in the northeastern United States, Hudson Yards sits on the west side of Midtown Manhattan at the heart of New York City's major central business district. Hudson Yards is within 25 kilometers of 3 major airports and within walking distance of commuter rail lines and subways. Hudson Yards is close to major New York City landmarks such as the Empire State Building, 1.3 kilometers to the east, and CEntral Park, 2.4 kilometers to the north.</p>
        </div>
      </div>
      <img class="img-responsive" src="img/map-1.jpg">
    </div>
  </section>

  <section class="section section-padding">
    <div class="container">
    <h2 class="section-title">Master Plan: Mixed Use</h2>
      <div class="row">
        <div class="col-md-6">
          <h3 class="section-title">Eastern Yard</h3>
          <div class="table-responsive">
            <table class="table">
              <tr>
                <td>Office</td>
                <td align="right">733,934 <abbr data-toggle="tooltip" title="Gross Square Meter">GSM</abbr></td>
              </tr>
              <tr>
                <td>Retail</td>
                <td align="right">97,548 <abbr data-toggle="tooltip" title="Gross Square Meter">GSM</abbr></td>
              </tr>
              <tr>
                <td>Hotel</td>
                <td align="right">20,439 <abbr data-toggle="tooltip" title="Gross Square Meter">GSM</abbr></td>
              </tr>
              <tr>
                <td>Residential</td>
                <td align="right">173,729 <abbr data-toggle="tooltip" title="Gross Square Meter">GSM</abbr></td>
              </tr>
              <tr>
                <td>Culture Shed</td>
                <td align="right">18,581 <abbr data-toggle="tooltip" title="Gross Square Meter">GSM</abbr></td>
              </tr>
              <tr class="active">
                <td>Total</td>
                <td align="right">1,044,231 <abbr data-toggle="tooltip" title="Gross Square Meter">GSM</abbr></td>
              </tr>
              <tr>
                <td>Open Space</td>
                <td align="right">2.6 Hectares</td>
              </tr>
              <tr>
                <td>Total Lot Area</td>
                <td align="right">6.27 Hectares</td>
              </tr>
            </table>
          </div>
        </div>
        <div class="col-md-6">
          <h3 class="section-title">Manhattan Tower</h3>
          <div class="table-responsive">
            <table class="table">
              <tr>
                <td>30 Hudson Yards</td>
                <td align="right">241,548 <abbr data-toggle="tooltip" title="Gross Square Meter">GSM</abbr></td>
              </tr>
              <tr>
                <td>The Shops &amp; Restaurants</td>
                <td align="right">92,903 <abbr data-toggle="tooltip" title="Gross Square Meter">GSM</abbr></td>
              </tr>
              <tr>
                <td>F&amp;B Pavilion</td>
                <td align="right">4,645 <abbr data-toggle="tooltip" title="Gross Square Meter">GSM</abbr></td>
              </tr>
              <tr>
                <td colspan="2">Landscape Sculpture</td>
              </tr>
              <tr>
                <td colspan="2">Cogen</td>
              </tr>
            </table>
          </div>
        </div>
